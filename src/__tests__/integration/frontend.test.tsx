...
function createStubBackend(overrides: Partial<SermonBackend> = {}): SermonBackend {
  const base: SermonBackend = {
    ...
    // Track O research-packet surface (stubs — transport shapes only).
    attachResearchFile: jest.fn().mockResolvedValue({
      id: 'att-001',
      originalFilename: 'notes.pdf',
      storedFilename: 'att-001.pdf',
      dateAdded: '2026-01-01T00:00:00Z',
      mimeType: 'application/pdf',
      byteSize: 0,
      checksum: 'stub',
      extraction: 'ok',
      importProvenance: { importedFrom: 'notes.pdf', importedAt: '2026-01-01T00:00:00Z' },
      provenanceClass: 'research-packet',
    }),
    listResearchAttachments: jest.fn().mockResolvedValue([]),
    getResearchAttachment: jest.fn().mockResolvedValue({
      id: 'att-001',
      originalFilename: 'notes.pdf',
      storedFilename: 'att-001.pdf',
      dateAdded: '2026-01-01T00:00:00Z',
    ...
    getExtractedPages: jest.fn().mockResolvedValue([]),
    updateResearchMetadata: jest.fn().mockResolvedValue({
      id: 'att-001',
      originalFilename: 'notes.pdf',
      storedFilename: 'att-001.pdf',
      dateAdded: '2026-01-01T00:00:00Z',
    ...
    removeResearchAttachment: jest.fn().mockResolvedValue(undefined),
    openResearchFile: jest.fn().mockResolvedValue({ absolutePath: '/tmp/notes.pdf' }),
  };
